...
function Demo() {
  ...
  const { data: districts, loading: loadingDistricts } = useDistricts(provinceCode?.value);
  const { data: subdistricts, loading: loadingSubdistricts } = useSubdistricts(districtCode?.value);
  const { data: villages, loading: loadingVillages } = useVillages(subdistrictCode?.value);
